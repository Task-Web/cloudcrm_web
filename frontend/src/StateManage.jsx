...
const dataFields = [
  {
    title: "data",
    description: "Object. CRM-style workspace data.",
  },
  {
    title: "data.user",
    description: "Object. Signed-in user profile (name, email, role, timezone, theme).",
  },
  {
    title: "data.users",
    description: "Array<User>. Team roster used by ownership fields and chatter.",
  },
  {
    title: "data.leads",
    description: "Array<Lead>. Lead records with status, rating, and contact details.",
  },
  {
    title: "data.accounts",
    description: "Array<Account>. Account records with billing/shipping info.",
  },
  {
    title: "data.contacts",
    description: "Array<Contact>. Contact records tied to accounts.",
  },
  {
    title: "data.opportunities",
    description: "Array<Opportunity>. Pipeline deals and close dates.",
  },
  {
    title: "data.cases",
    description: "Array<Case>. Support cases with status and priority.",
  },
  {
    title: "data.activities",
    description: "Array<Activity>. Tasks/events used for the calendar and timelines.",
  },
  {
    title: "data.chatterPosts",
    description: "Array<ChatterPost>. Social updates, likes, and comments.",
  },
  {
    title: "data.files",
    description: "Array<FileItem>. File metadata referenced in the Files app.",
  },
  {
    title: "data.following",
    description: "Array<string>. User ids followed in chatter.",
  },
  {
    title: "data.dashboards",
    description: "Array<Dashboard>. Optional dashboard presets created by the user.",
  },
];
